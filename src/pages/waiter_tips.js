...
function Waiter_tips() {
    ...
    return (
        ...
        <h2 className='login'>Tips You Received</h2>
        <form >
            <div class="container">
                ...
                <Button type = "button" onClick={async () => {
                        ...
                        var url = new URL('http://35.211.4.196:5000/waiter_tips'),
        ...
        <h1> Your Total Tips: {data} </h1>
        </div>
    )
}

export default Waiter_tips